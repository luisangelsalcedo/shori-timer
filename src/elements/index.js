...
divTimerTop.classList.add('timer-content-top');
divTimerTop.innerHTML = imageAlamr + imageTimer; 
divTimerTop.append(timerDigits);

// timer-content-bottom
const divTimerBottom = document.createElement("div");
divTimerBottom.classList.add('timer-content-bottom');
divTimerBottom.append(timerData);


// timer-content
const divTimerContent = document.createElement("div");
divTimerContent.classList.add('timer-content');
divTimerContent.append(divTimerTop);
divTimerContent.append(divTimerBottom);
divTimer.append(divTimerContent);


// timer-btn
export const btnRefreshTimer = document.createElement("button");
btnRefreshTimer.classList.add('timer-btn')
btnRefreshTimer.innerHTML = logosvg + "<span>Timer</span>"; //imageTimer + "<span>Timer</span>";


// icons
export const svgtime = divTimerTop.querySelector(".timer-icon");
export const svgalarm = divTimerTop.querySelector(".alarm-icon");
